...
![Пример работы программы](Eye/Eyes_example.gif)
...
Большинство аспектов поведения и внешнего вида глаз можно настроить, изменив значения переменных в верхней части файла `eyes.py`. Вот параметры:
...
*   **Проблема с перетаскиванием окна:** Окно ненадолго уходит в "фриз" при взаимодействии с ним. То есть непосредственно при интеракции "перетащить из одной области в другую".

## 🌱 Возможные улучшения и идеи для развития (если не лень будет)

*   **Текстурирование:** Добавить возможность использования текстур для радужки и/или белка глаза для большего свега.
...
*   **Реакция на клики:** Добавить реакцию на клики мыши.
...
*   **Конфигурационный файл:** Вынести настраиваемые параметры в отдельный конфигурационный файл (Типа, `.json` или `.ini`) для удобства изменения без правки кода.
